...
本库采用 **Cursor Skill 标准结构**：扁平 `references/` + YAML 元数据标签，与 [vibe-motion](https://github.com) 动效库保持一致，方便脚本生成 catalog 并供 [vibe-ui-web](https://github.com) 线上展示。
